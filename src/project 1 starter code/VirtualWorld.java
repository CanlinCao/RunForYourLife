   ...
   */
      ...
      EventScheduler scheduler, ImageStore imageStore)
   {
      for (Entity entity : world.getEntities())
      {
         ...
         if (entity instanceof EntityLayerOne) {
            EntityLayerOne entityWithActionPeriod = (EntityLayerOne) entity;
            if (entityWithActionPeriod.getActionPeriod() > 0)
               entityWithActionPeriod.scheduleActions(scheduler, world, imageStore);
         }
      }
   }
